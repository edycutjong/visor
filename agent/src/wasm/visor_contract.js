...
import { checkAuthorized } from 'host:interfaces/authorisation';
...
import { enqueue } from 'host:outbox/outbox';
import { callingUserDid, clusterTimestampSecs, tenantDid } from 'host:tenant/tenant-context';
import { queryPayment } from 'visor:agent/chain-rpc';
import { verifyProof } from 'visor:agent/zk-verify';
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./visor_contract.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('');
...
export { contracts100 as contracts, contracts100 as 'visor:agent/contracts@1.0.0',  }