...
if (!getCoreModule) getCoreModule = (name) => fetchCompile(new URL(`./${name}`, typeof __filename !== 'undefined' ? 'file://' + __filename : ''));
const module0 = getCoreModule('visor_contract.core.wasm');
const module1 = getCoreModule('visor_contract.core2.wasm');
const module2 = getCoreModule('visor_contract.core3.wasm');

const { checkAuthorized } = imports['host:interfaces/authorisation'];

if (checkAuthorized=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'checkAuthorized', was 'checkAuthorized' available at instantiation?");
...
const { sign } = imports['host:interfaces/signing'];

if (sign=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'sign', was 'sign' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}

const { enqueue } = imports['host:outbox/outbox'];

if (enqueue=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'enqueue', was 'enqueue' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}

const { callingUserDid, clusterTimestampSecs, tenantDid } = imports['host:tenant/tenant-context'];

if (callingUserDid=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'callingUserDid', was 'callingUserDid' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
const { queryPayment } = imports['visor:agent/chain-rpc'];

if (queryPayment=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'queryPayment', was 'queryPayment' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}

const { verifyProof } = imports['visor:agent/zk-verify'];

if (verifyProof=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'verifyProof', was 'verifyProof' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
let gen = (function* _initGenerator () {
  ...
  _trampoline3.fnName = 'wasi:cli/stderr@0.2.6#getStderr';
  ...
  _trampoline4.fnName = 'wasi:cli/exit@0.2.6#exit';
  let exports1;
  let memory0;
  let realloc0;
  let realloc0Async;
...
_trampoline5.fnName = 'host:interfaces/logging@2.1.0#info';

const _trampoline6 = function(arg0) {
  _debugLog('[iface="host:tenant/tenant-context@1.0.0", function="calling-user-did"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  _debugLog('[iface="host:tenant/tenant-context@1.0.0", function="calling-user-did"][Instruction::Return]', {
    funcName: 'calling-user-did',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline6.fnName = 'host:tenant/tenant-context@1.0.0#callingUserDid';
...
_trampoline8.fnName = 'host:interfaces/kv-store@2.1.0#put';
...
_trampoline9.fnName = 'host:interfaces/kv-store@2.1.0#get';
...
_trampoline10.fnName = 'host:interfaces/signing@2.1.0#sign';

const _trampoline11 = function(arg0, arg1, arg2) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="visor:agent/chain-rpc@1.0.0", function="query-payment"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_debugLog('[iface="visor:agent/chain-rpc@1.0.0", function="query-payment"][Instruction::Return]', {
  funcName: 'query-payment',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline11.fnName = 'visor:agent/chain-rpc@1.0.0#queryPayment';
...
const _trampoline12 = function(arg0, arg1, arg2, arg3, arg4) {
  ...
  _debugLog('[iface="visor:agent/zk-verify@1.0.0", function="verify-proof"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => verifyProof(result0, result1),
    })
  };
} catch (e) {
  ret = { tag: 'err', val: getErrorPayload(e) };
...
_debugLog('[iface="visor:agent/zk-verify@1.0.0", function="verify-proof"][Instruction::Return]', {
  funcName: 'verify-proof',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline12.fnName = 'visor:agent/zk-verify@1.0.0#verifyProof';

const _trampoline13 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  let enum1;
  ...
  _debugLog('[iface="host:outbox/outbox@1.0.0", function="enqueue"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  case 'err': {
    ...
    switch (variant12.tag) {
      case 'invalid-idk': {
        ...
        dataView(memory0).setUint32(arg9 + 12, len7, true);
        dataView(memory0).setUint32(arg9 + 8, ptr7, true);
        break;
      }
      case 'idk-collision': {
      ...
      case 'host-not-allowed': {
        ...
        dataView(memory0).setUint32(arg9 + 12, len8, true);
        dataView(memory0).setUint32(arg9 + 8, ptr8, true);
        break;
      }
      case 'invalid-url': {
        const e = variant12.val;
        dataView(memory0).setInt8(arg9 + 4, 5, true);
      ...
      case 'kv': {
        const e = variant12.val;
        dataView(memory0).setInt8(arg9 + 4, 6, true);
      ...
      case 'decode': {
        const e = variant12.val;
        dataView(memory0).setInt8(arg9 + 4, 7, true);
      ...
      case 'leader-only': {
        dataView(memory0).setInt8(arg9 + 4, 8, true);
        break;
      }
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant12.tag)}\` (received \`${variant12}\`) specified for \`OutboxError\``);
      }
    }
...
_debugLog('[iface="host:outbox/outbox@1.0.0", function="enqueue"][Instruction::Return]', {
  funcName: 'enqueue',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline13.fnName = 'host:outbox/outbox@1.0.0#enqueue';
...
const _trampoline14 = function(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="host:interfaces/authorisation@2.1.0", function="check-authorized"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
switch (variant5.tag) {
  ...
  case 'err': {
    ...
    switch (variant4.tag) {
      ...
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant4.tag)}\` (received \`${variant4}\`) specified for \`AuthError\``);
      }
    }
...
_debugLog('[iface="host:interfaces/authorisation@2.1.0", function="check-authorized"][Instruction::Return]', {
  funcName: 'check-authorized',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline14.fnName = 'host:interfaces/authorisation@2.1.0#checkAuthorized';

const _trampoline15 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
  let enum0;
  switch (arg0) {
    case 0: {
      enum0 = 'get';
...
_trampoline15.fnName = 'host:interfaces/http-with-placeholders@2.1.0#call';
...
_trampoline16.fnName = 'wasi:io/error@0.2.6#toDebugString';
...
_trampoline17.fnName = 'wasi:io/streams@0.2.6#blockingWriteAndFlush';
...
let contracts100RegisterTemplate;

function registerTemplate(arg0) {
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="register-template"][Instruction::CallWasm] enter', {
    funcName: 'register-template',
    paramCount: 9,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'contracts100RegisterTemplate',
    getCallbackFn: () => null,
    callbackFnName: null,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => contracts100RegisterTemplate(variant2_0, variant2_1, variant2_2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2),
    });
  } catch (err) {
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="register-template"][Instruction::Return]', {
    funcName: 'register-template',
    paramCount: 1,
    async: false,
    postReturn: true
...
let contracts100DraftSubmission;

function draftSubmission(arg0) {
  var {input: v0_0, userProfile: v0_1, context: v0_2 } = arg0;
  var variant2 = v0_0;
  let variant2_0;
  let variant2_1;
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="draft-submission"][Instruction::CallWasm] enter', {
    funcName: 'draft-submission',
    paramCount: 9,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'contracts100DraftSubmission',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => contracts100DraftSubmission(variant2_0, variant2_1, variant2_2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2),
    });
  } catch (err) {
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="draft-submission"][Instruction::Return]', {
    funcName: 'draft-submission',
    paramCount: 1,
    async: false,
    postReturn: true
...
let contracts100BlindSubmit;

function blindSubmit(arg0) {
  var {input: v0_0, userProfile: v0_1, context: v0_2 } = arg0;
  var variant2 = v0_0;
  let variant2_0;
  let variant2_1;
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="blind-submit"][Instruction::CallWasm] enter', {
    funcName: 'blind-submit',
    paramCount: 9,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'contracts100BlindSubmit',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => contracts100BlindSubmit(variant2_0, variant2_1, variant2_2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2),
    });
  } catch (err) {
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="blind-submit"][Instruction::Return]', {
    funcName: 'blind-submit',
    paramCount: 1,
    async: false,
    postReturn: true
...
function finalize(arg0) {
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="finalize"][Instruction::CallWasm] enter', {
    funcName: 'finalize',
    paramCount: 9,
    async: false,
    postReturn: true,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'contracts100Finalize',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => contracts100Finalize(variant2_0, variant2_1, variant2_2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2),
    });
  } catch (err) {
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="finalize"][Instruction::Return]', {
    funcName: 'finalize',
    paramCount: 1,
    async: false,
    postReturn: true
...
let contracts100GetStatus;

function getStatus(arg0) {
  var {input: v0_0, userProfile: v0_1, context: v0_2 } = arg0;
  var variant2 = v0_0;
  let variant2_0;
  let variant2_1;
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="get-status"][Instruction::CallWasm] enter', {
    funcName: 'get-status',
    paramCount: 9,
    async: false,
    postReturn: true,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'contracts100GetStatus',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => contracts100GetStatus(variant2_0, variant2_1, variant2_2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2),
    });
  } catch (err) {
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="get-status"][Instruction::Return]', {
    funcName: 'get-status',
    paramCount: 1,
    async: false,
    postReturn: true
...
let contracts100VerifyReceipt;

function verifyReceipt(arg0) {
  var {input: v0_0, userProfile: v0_1, context: v0_2 } = arg0;
  var variant2 = v0_0;
  let variant2_0;
  let variant2_1;
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="verify-receipt"][Instruction::CallWasm] enter', {
    funcName: 'verify-receipt',
    paramCount: 9,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'contracts100VerifyReceipt',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => contracts100VerifyReceipt(variant2_0, variant2_1, variant2_2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2),
    });
  } catch (err) {
  ...
  _debugLog('[iface="visor:agent/contracts@1.0.0", function="verify-receipt"][Instruction::Return]', {
    funcName: 'verify-receipt',
    paramCount: 1,
    async: false,
    postReturn: true
...
null,
{
  ...
  paramLiftFns: [_liftFlatStringAny,_liftFlatRecord({ fieldMetas: [['method', 
  _liftFlatEnum({
  ...
  , 1, 1],['url', _liftFlatStringAny, 8, 4],['headers', _liftFlatList({
    elemLiftFn: _liftFlatTuple({ elemLiftFns: [[_liftFlatStringAny, 8, 4],[_liftFlatStringAny, 8, 4],], size32: 16, align32: 4 }),
    elemAlign32: 4,
    elemSize32: 16,
    typedArray: undefined,
  }), 8, 4],['body', _liftFlatList({
    elemLiftFn: _liftFlatU8,
    elemAlign32: 1,
    elemSize32: 1,
    typedArray: Uint8Array,
  }), 8, 4],], size32: 28, align32: 4 })],
  resultLowerFns: [
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', null, 16, 4, 4 ],
    [ 'err', _lowerFlatVariant({
      caseMetas: [[ 'invalid-idk', _lowerFlatStringAny, 8, 4, 2 ],[ 'idk-collision', null, 0, 0, 0 ],[ 'outbox-full', null, 0, 0, 0 ],[ 'no-active-tx', null, 0, 0, 0 ],[ 'host-not-allowed', _lowerFlatStringAny, 8, 4, 2 ],[ 'invalid-url', _lowerFlatStringAny, 8, 4, 2 ],[ 'kv', _lowerFlatStringAny, 8, 4, 2 ],[ 'decode', _lowerFlatStringAny, 8, 4, 2 ],[ 'leader-only', null, 0, 0, 0 ],],
      variantSize32: 12,
      variantAlign32: 4,
      variantPayloadOffset32: 4,
      variantFlatCount: 3,
...
null,
{
  ...
  _lowerFlatResult({
    ...
    [ 'ok', null, 16, 4, 4 ],
    [ 'err', _lowerFlatVariant({
      caseMetas: [[ 'denied-unauthorized', _lowerFlatStringAny, 8, 4, 2 ],[ 'denied-no-allowlist', null, 0, 0, 0 ],[ 'denied-scope', _lowerFlatStringAny, 8, 4, 2 ],[ 'denied-revoked', null, 0, 0, 0 ],],
      variantSize32: 12,
      variantAlign32: 4,
      variantPayloadOffset32: 4,
      variantFlatCount: 3,
...
({ exports: exports1 } = yield instantiateCore(yield module0, {
  ...
  'host:tenant/tenant-context@1.0.0': {
    'calling-user-did': exports0['1'],
    'cluster-timestamp-secs': trampoline0,
    'tenant-did': exports0['2'],
  },
  'visor:agent/chain-rpc@1.0.0': {
    'query-payment': exports0['6'],
  },
  'visor:agent/zk-verify@1.0.0': {
    'verify-proof': exports0['7'],
  },
  ...
  'wasi:io/error@0.2.4': {
    '[method]error.to-debug-string': exports0['11'],
...
postReturn0 = exports1['cabi_post_visor:agent/contracts@1.0.0#blind-submit'];

try {
  postReturn0Async = WebAssembly.promising(exports1['cabi_post_visor:agent/contracts@1.0.0#blind-submit']);
} catch(err) {
  postReturn0Async = exports1['cabi_post_visor:agent/contracts@1.0.0#blind-submit'];
}

contracts100RegisterTemplate = exports1['visor:agent/contracts@1.0.0#register-template'];
contracts100DraftSubmission = exports1['visor:agent/contracts@1.0.0#draft-submission'];
contracts100BlindSubmit = exports1['visor:agent/contracts@1.0.0#blind-submit'];
contracts100Finalize = exports1['visor:agent/contracts@1.0.0#finalize'];
contracts100GetStatus = exports1['visor:agent/contracts@1.0.0#get-status'];
contracts100VerifyReceipt = exports1['visor:agent/contracts@1.0.0#verify-receipt'];
const contracts100 = {
...
return { contracts: contracts100, 'visor:agent/contracts@1.0.0': contracts100,  };
})();
